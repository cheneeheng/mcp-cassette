...
## HT-06.1 Read the timeline when a replay misses
...
## HT-06.3 List the recorded tools
...
## HT-06.4 Machine-readable output
...
## HT-06.5 Compare two recordings
...
## HT-06.6 `diff` versus lint's R002
...
## HT-06.7 No pager, no color, no TUI
