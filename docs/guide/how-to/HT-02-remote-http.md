...
## HT-02.2 Use `server_url` instead of `server_command`
...
## HT-02.3 Prove the remote is never contacted
...
## HT-02.4 Headers and credentials
...
see [HT-07. Redact secrets](HT-07-redact-secrets.md).
