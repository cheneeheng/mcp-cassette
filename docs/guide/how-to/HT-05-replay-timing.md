...
## HT-05.2 What it does and does not do
...
## HT-05.3 Why `--pace-cap-ms` defaults to 5000
...
## HT-05.4 Pacing and faults compose
...
## HT-05.5 The invariant this bends, deliberately
...
- [HT-04. Inject faults](HT-04-inject-faults.md)
