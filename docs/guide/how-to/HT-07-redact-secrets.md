...
## HT-07.1 Defaults are always on
...
## HT-07.3 Limits you must know about
...
model. See [OP-03. CI pipeline](../operations/OP-03-ci.md#op-033-lint-cassettes-before-they-reach-a-model).
